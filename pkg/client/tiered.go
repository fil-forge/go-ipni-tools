...
// NewTieredFinder creates a new [client.Finder] with the provided tiers and
// options.
//
...
func NewTieredFinder(tiers []client.Finder, opts ...TieredFinderOption) (*TieredFinder, error) {
...
var _ client.Finder = (*TieredFinder)(nil)
